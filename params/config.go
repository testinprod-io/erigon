...
var (
	...
	GnosisWithdrawalsDevnet3GenesisHash = libcommon.HexToHash("0xe53bef5cbf12cadbef3d950fbf63cc9010866eae4142cc103c46e4315bd442e9")
)
...
var (
	...
	GnosisWithdrawalsDevnet3GenesisStateRoot = libcommon.HexToHash("0xfbab5f37798a40ce358f785d1d005dd5ecdb667e5ef0ab10f7582756ceecc4d8")
)
...
var (
	...
	GnosisWithdrawalsDevnet3ChainConfig = readChainSpec("chainspecs/gnosis_withdrawals_devnet_3.json")
...
func ChainConfigByChainName(chain string) *chain.Config {
	...
	case networkname.GnosisWithdrawalsDevnet3Name:
		return GnosisWithdrawalsDevnet3ChainConfig
	default:
		return nil
	}
}
...
func GenesisHashByChainName(chain string) *libcommon.Hash {
	...
	case networkname.GnosisWithdrawalsDevnet3Name:
		return &GnosisWithdrawalsDevnet3GenesisHash
	default:
		return nil
	}
}
...
func ChainConfigByGenesisHash(genesisHash libcommon.Hash) *chain.Config {
	...
	case genesisHash == ChiadoGenesisHash:
		return ChiadoChainConfig
	case genesisHash == GnosisWithdrawalsDevnet3GenesisHash:
		return GnosisWithdrawalsDevnet3ChainConfig
	default:
		return nil
	}
